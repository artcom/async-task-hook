...
describe("useMqttSubscribe", () => {
  ...
  it("should not re-run task on rerender", async () => {
    const results = []
  ...
  it("should run another task after first task", async () => {
    const results = []
  ...
  it("should run another task after first task cancelled", async () => {
    const results = []
